...
class Coin(models.Model):
    name = models.CharField(
        max_length=100, unique=True, verbose_name="Название монеты"
    )
    symbol = models.CharField(
        max_length=10, unique=True, verbose_name="Символ монеты"
    )
